...
call {
    ...
    if (_cargo_type == 11) exitWith {
		...
		_cargo addMagazineCargoGlobal ["200Rnd_556x45_Box_Tracer_F", 5]; 
		_cargo addMagazineCargoGlobal ["100Rnd_580x42_Mag_Tracer_F", 5]; 
		_cargo addMagazineCargoGlobal ["150Rnd_556x45_Drum_Mag_Tracer_F", 5];
		_cargo addMagazineCargoGlobal ["30Rnd_545x39_Mag_Tracer_Green_F", 5];		
		_cargo addMagazineCargoGlobal ["30Rnd_580x42_Mag_Tracer_F", 7];
		_cargo addMagazineCargoGlobal ["30Rnd_762x39_Mag_Tracer_Green_F", 5];
		...
		_cargo addMagazineCargoGlobal ["RPG7_F", 5];
    ...
    if (_cargo_type == 12) exitWith {
		...
		_cargo addMagazineCargoGlobal ["150Rnd_556x45_Drum_Mag_Tracer_F", 5];
		_cargo addMagazineCargoGlobal ["30Rnd_545x39_Mag_Tracer_Green_F", 5];		
		_cargo addMagazineCargoGlobal ["30Rnd_580x42_Mag_Tracer_F", 14];
		_cargo addMagazineCargoGlobal ["30Rnd_762x39_Mag_Tracer_Green_F", 5];
		...
		_cargo addMagazineCargoGlobal ["NLAW_F", 7]; 
		_cargo addMagazineCargoGlobal ["Titan_AT", 5]; 
		_cargo addMagazineCargoGlobal ["Titan_AA", 5;
		_cargo addMagazineCargoGlobal ["RPG7_F", 10];
    ...
    if (_cargo_type == 13) exitWith {_cargo = "FlexibleTank_01_forest_F" createVehicle (getMarkerPos "Ammo_Supply_drop");
        sleep 0.1;
    };
};
