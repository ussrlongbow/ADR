...
_gh_huron = ["B_Heli_Transport_01_camo_F", "B_Heli_Transport_01_F", "B_Heli_Transport_03_F", "B_CTRG_Heli_Transport_01_tropic_F"]; 	// ghosthawk and huron
_huron = ["B_Heli_Transport_03_F", "B_Heli_Transport_03_unarmed_F"];																		// huron
